...
# First find out under which docker network the "github.com/Me-Phew/ada-assistant-backend" project is available (as started via ./docker-helper.sh --up).
